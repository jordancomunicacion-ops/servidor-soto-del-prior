...
import '../../web.css'; // Re-use web styles
    ...
    return (
        <main className="min-h-screen bg-[#F4F4F4] font-sans">
            <div className="bg-black text-white p-4 px-8">
                <Link href="/web" className="text-sm font-bold opacity-70 hover:opacity-100">← VOLVER A LA TIENDA</Link>
            </div>
            ...
            <div className="text-center pb-12">
                <Link href="/web/checkout" className="text-[#C59D5F] font-bold underline uppercase">Volver al Checkout</Link>
            </div>
        </main>
    );
}
