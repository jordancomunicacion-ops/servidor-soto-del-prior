    ...
    return (
        <main className="min-h-screen bg-[#0A0A0A] text-white flex flex-col items-center justify-center p-8 font-sans">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 w-full max-w-6xl">
                ...
                {/* 2. APP GANADERA */}
                <a href="http://ganaderia.sotodelprior.com" target="_blank" className="group relative block p-8 bg-[#151515] border border-[#333] hover:border-[#C59D5F] transition-all duration-300 hover:transform hover:-translate-y-1">
                    <div className="absolute top-4 right-4 text-[#C59D5F] opacity-50 group-hover:opacity-100">
                    ...
                    <span className="block mt-4 text-xs font-mono text-gray-600 bg-black/50 px-2 py-1 w-fit rounded">ganaderia.sotodelprior.com</span>
                </a>

                {/* 3. APP COCINA */}
                <a href="http://cocina.sotodelprior.com" target="_blank" className="group relative block p-8 bg-[#151515] border border-[#333] hover:border-[#C59D5F] transition-all duration-300 hover:transform hover:-translate-y-1">
                    <div className="absolute top-4 right-4 text-[#C59D5F] opacity-50 group-hover:opacity-100">
                    ...
                    <span className="block mt-4 text-xs font-mono text-gray-600 bg-black/50 px-2 py-1 w-fit rounded">cocina.sotodelprior.com</span>
                </a>

                {/* 4. RESERVAS (Moved Up) */}
                <a href="http://reservas.sotodelprior.com/admin" target="_blank" className="group relative block p-8 bg-[#151515] border border-[#333] hover:border-[#C59D5F] transition-all duration-300 hover:transform hover:-translate-y-1">
                    <div className="absolute top-4 right-4 text-[#C59D5F] opacity-50 group-hover:opacity-100">
                    ...
                    <span className="block mt-4 text-xs font-mono text-gray-600 bg-black/50 px-2 py-1 w-fit rounded">reservas.sotodelprior.com</span>
                </a>

                {/* 5. CRM & CAMPAIGNS */}
                <a href="http://crm.sotodelprior.com" target="_blank" className="group relative block p-8 bg-[#151515] border border-[#333] hover:border-[#C59D5F] transition-all duration-300 hover:transform hover:-translate-y-1">
                    <div className="absolute top-4 right-4 text-[#C59D5F] opacity-50 group-hover:opacity-100">
                    ...
                    <span className="block mt-4 text-xs font-mono text-gray-600 bg-black/50 px-2 py-1 w-fit rounded">crm.sotodelprior.com</span>
                </a>
