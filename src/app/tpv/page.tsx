    ...
    return (
        <main className="min-h-screen bg-[#0A0A0A] text-white flex flex-col items-center justify-center p-8 font-sans">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full max-w-4xl">
                ...
                {/* TPV OBRADOR */}
                <a href="http://localhost:3002/pos/obrador" target="_blank" className="group relative block p-12 bg-[#151515] border border-[#333] hover:border-[#C59D5F] transition-all duration-300 hover:scale-105">
                    <div className="text-center">
                        ...
                        <p className="text-gray-500">Venta directa en tienda y gestión de pedidos.</p>
                    </div>
                </a>

                {/* TPV RESTAURANTE */}
                <a href="http://localhost:3002/pos/restaurante" target="_blank" className="group relative block p-12 bg-[#151515] border border-[#333] hover:border-[#C59D5F] transition-all duration-300 hover:scale-105">
                    <div className="text-center">
                        <div className="mb-6 inline-block p-4 rounded-full bg-[#C59D5F]/10 text-[#C59D5F]">
